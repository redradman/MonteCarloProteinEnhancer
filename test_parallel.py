...
if len(sys.argv) <= 1:
    raise ValueError("No argument provided! Please provide the $PBS_ARRAY_INDEX value.")
else:
    pbs_array_index = sys.argv[1]

# Load the protein pose
pose = Pose()
pyrosetta.rosetta.core.import_pose.pose_from_file(pose, "/scratch/st-shallam-1/iGEM/monte-carlo/MonteCarloProteinEnhancer/pdb_files/dockedNrdj-1mCherry.pdb")
...
output_dir = f"/scratch/st-shallam-1/iGEM/monte-carlo/decoy_folder/{pbs_array_index}"
